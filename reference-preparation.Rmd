...
# We also exlude an overrepresented and poorly characterized epitope from this pool to avoid biasing the negative data
negative.reference <- negative.reference %>% 
    filter(Epitope != "KLGGALQAK")
...
neg.gen.out.path <- "./reference-data/high-confidence-generated-negatives-2/"
