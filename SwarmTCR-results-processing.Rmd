...
plotPrecisionRecall(pr.dfs = pr.swarmTCR, epitopes = target.epitopes, directory = paste0(plots.path, "SwarmTCR_"))
ggsave(paste0(plots.path, "SwarmTCR-PR-curve.png"), plot, width = 15, height = 15)

plotPrecisionRecall(pr.dfs = pr.TCRdist, epitopes = target.epitopes, directory = paste0(plots.path, "TCRdist_"))
ggsave(paste0(plots.path, "TCRdist-PR-curve.png"), plot, width = 15, height = 15)
...
ggsave(paste0(plots.path, "SwarmTCR-scores.png"), plot, width = 20, height = 10)


plotPrecisionRecall(pr.dfs = pr.swarmTCR, epitopes = target.epitopes, directory = plots.path, thresholds = score.thresholds)
ggsave(paste0(plots.path, "SwarmTCR-PR-curve-with-score-thresholds.png"), plot, width = 15, height = 15)
...
`for f in ./*_CDRs.txt; do ../../swarmTCRClassify -w ../reference-data/refWeights.txt -i $f; done;`

Then, proceed with the SwarmTCRClassify-results-processing.Rmd document to analyze performance and establish SwarmTCRClassify parameters using the pre-trained SwarmTCR model.
